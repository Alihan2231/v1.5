...
# Loglama
logger = logging.getLogger("NetworkShieldPro.helpers")
...
def format_timestamp(timestamp):
    ...
    try:
        ...
        logger.error(f"Zaman formatlarken hata: {e}")
        return "Bilinmiyor"
...
def format_time_ago(timestamp):
    ...
    try:
        ...
        logger.error(f"Zaman farkı formatlarken hata: {e}")
        return "Bilinmiyor"
...
def format_mac_for_display(mac_address):
    ...
    try:
        ...
        logger.error(f"MAC adresi formatlanırken hata: {e}")
...
def format_ip_for_display(ip_address):
    ...
    try:
        ...
        logger.error(f"IP adresi formatlanırken hata: {e}")
...
def create_threat_data_chart(scan_results):
    ...
    try:
        ...
        logger.error(f"Tehdit verisi oluşturulurken hata: {e}")
        return []
...
def create_scan_history_chart(scan_history):
    ...
    try:
        ...
        logger.error(f"Tarama geçmişi verisi oluşturulurken hata: {e}")
        return []
...
def get_network_security_score(scan_result):
    ...
    try:
        ...
        logger.error(f"Güvenlik skoru hesaplanırken hata: {e}")
        return 0
